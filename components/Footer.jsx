...
const Footer = () => {
  return (
    <footer className="flex items-center flex-col justify-between my-8 mx-5% text-center">
      ...
      <div className="my-2">
        <a className="mr-4 text-#111827 lg:text-4.5 md:text-3 text-3" href="">
          Conditions of Use
        </a>
        <a className="mr-4 text-#111827 lg:text-4.5 md:text-3 text-3" href="">
          Privacy & Policy
        </a>
        <a className="text-#111827 lg:text-4.5 md:text-3 text-3" href="">
          Press Room
        </a>
      </div>

      <p className="text-#6B7280 lg:text-4.5 md:text-3 text-3">
        © 2023 MovieBox by Chibuzor Anselm Obilor{" "}
      </p>
    </footer>
  );
};
