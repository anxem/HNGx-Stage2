...
const Hero = () => {
  ...
  return (
    <div
      className="w-full bg-cover bg-center h-screen bg-gradient-to-r from-black to-gray-400 "
      loading="lazy"
    ...
    >
      ...
      <section className="ml-3 md:ml-5% text-white w-95% md:w-30% mt-30 md:mt-20">
        ...
        <p className="my-8 pr-4 text-4">
          {truncateString(movie?.overview, 200)}
        </p>

        <Link
          to=""
          className="text-white py-2 px-5 rounded-1 bg-#BE123C hover:bg-red-500 transition"
        >
