...
const MovieCard = ({ movie }) => {
  ...
  const like = favourite ? favouritelike : unfavouritelike;
  ...
  return (
    <section className="box" data-testid="movie-card">
      <div className="w-full relative">
        <Link to={`/movies/${movie.id}`}>
          {movie.poster_path ? (
            ...
            <div className="text-xl text-center animate-bounce duration-500">
              No Image Found
            </div>
          )}
        </Link>
      ...
      <div>
        <p
          className="text-3 text-#9CA3AF my-2"
        ...
        <h1
          className="text-4 md:text-5 text-#111827 mb-2"
